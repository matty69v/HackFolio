...
title: 'TryHackMe - Tryhackme Tricipher Summit'
author : Matty
categories: [TryHackMe]
tags: [web, js, crypto, python, blockchain, foundry]
render_with_liquid: false
image:
  path: /images/tryhackme_tricipher_summit/room_image.webp
---
...
[![Tryhackme Room Link](/images/tryhackme_tricipher_summit/room_card.webp)](https://tryhackme.com/r/room/tryhack3mencryptionchallenge){: .center }
...
![Web Server Port 443 Index](/images/tryhackme_tricipher_summit/port_443_index.webp)

Visiting `https://cdn.tryhackm3.loc/ui`, we get the admin UI for S3 Ninja and discover a single bucket: `libraries`

![Web Server Port 443 S3 Ninja](/images/tryhackme_tricipher_summit/port_443_s3ninja.webp)
...
![Web Server Port 443 S3 Ninja Libraries](/images/tryhackme_tricipher_summit/port_443_s3ninja_libraries.webp)

### Port 5000

At `https://cdn.tryhackm3.loc:5000/`, we get a login page.

![Web Server Port 5000 Index](/images/tryhackme_tricipher_summit/port_5000_index.webp)
...
![Web Server Port 5000 Index Source](/images/tryhackme_tricipher_summit/port_5000_source.webp)

Also checking the access logs at S3 Ninja, we see multiple requests being made for `form-submit.js`.

![Web Server Port 444 S3 Ninja Access Logs](/images/tryhackme_tricipher_summit/port_443_s3ninja_access_logs.webp)
...
![Web Server Port 443 S3 Ninja Creds](/images/tryhackme_tricipher_summit/port_443_s3ninja_creds.webp)

Checking the file, we get a set of credentials.

![Web Server Port 443 Creds](/images/tryhackme_tricipher_summit/port_443_creds.webp)
...
![Web Server Port 5000 Login](/images/tryhackme_tricipher_summit/port_5000_login.webp)

## Second Flag

At `https://cdn.tryhackm3.loc:5000/supersecretotp`, we see a form for submitting an OTP.

![Web Server Port 5000 OTP](/images/tryhackme_tricipher_summit/port_5000_otp.webp)
...
![Web Server Port 3000 Index](/images/tryhackme_tricipher_summit/port_3000_index.webp)
...
![Web Server Port 3000 Flag](/images/tryhackme_tricipher_summit/port_3000_flag.webp)
