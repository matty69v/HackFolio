...
image:
  path: /images/tryhackme_block/room_card.webp
---
...
![Wireshark Statistics](/images/tryhackme_block/wireshark_statistics.webp)

Looking at the traffic manually, first we see a login for the user `mrealman`.

![Wireshark SMB First Login](/images/tryhackme_block/smb_first_login.webp)

After that, we also see a login for the user `eshellstrop`.

![Wireshark SMB Second Login](/images/tryhackme_block/smb_second_login.webp)

Lastly, we also see some encrypted SMB3 traffic.

![Wireshark SMB Second Login](/images/tryhackme_block/smb_encrypted_traffic.webp)
...
![CrackStation](/images/tryhackme_block/crackstation.webp)
...
![Mrealman Arguments](/images/tryhackme_block/mrealman_arguments.webp)
...
![Mrealman Session ID](/images/tryhackme_block/mrealman_session_id.webp)
...
![SMB Add Session Key](/images/tryhackme_block/smb_add_session_key.webp)

We need to reverse the bytes on the session ID due to endianness.

![SMB First Session Key Added](/images/tryhackme_block/smb_first_session_key_added.webp)
...
![SMB Decrypted Traffic First](/images/tryhackme_block/decrypted_smb3_traffic_first.webp)

We can use `Wireshark` to export the file like so:

![Wireshark Export SMB](/images/tryhackme_block/wireshark_export_smb.webp)

![Export Clients156 CSV](/images/tryhackme_block/export_clients156_csv.webp)
...
![Eeshellstrop Arguments](/images/tryhackme_block/eshellstrop_arguments.webp)
...
![Eeshellstrop Session ID](/images/tryhackme_block/eshellstrop_session_id.webp)
...
![SMB Second Session Key Added](/images/tryhackme_block/smb_second_session_key_added.webp)

Once again, we see that the `SMB3` traffic is decrypted, and this time we see the user accessing the `clients978.csv` file.

![SMB Decrypted Traffic Second](/images/tryhackme_block/decrypted_smb3_traffic_second.webp)

Exporting it the same way as before.

![Export Clients978 CSV](/images/tryhackme_block/export_clients978_csv.webp)
