...
image:
  path: /images/tryhackme_dx2_hells_kitchen/room_image.webp
---
...
![Web 80 Index](/images/tryhackme_dx2_hells_kitchen/web_80_index.webp)

### WEB 4346

And checking `http://10.10.131.31:4346/`, we get a login page.

![Web 4346 Index](/images/tryhackme_dx2_hells_kitchen/web_4346_index.webp)
...
![Web 80 Source](/images/tryhackme_dx2_hells_kitchen/web_80_source.webp)
...
![Web 80 New Booking](/images/tryhackme_dx2_hells_kitchen/web_80_newbooking.webp)
...
![Web 80 New Booking Source](/images/tryhackme_dx2_hells_kitchen/web_80_newbooking_source.webp)
...
![Web 80 Booking Info Request](/images/tryhackme_dx2_hells_kitchen/web_80_bookinginfo_request.webp)
...
![Web 4346 Mail](/images/tryhackme_dx2_hells_kitchen/web_4346_mail.webp)

Checking the message from the `JReyes` user, we get the web flag.

![Web 4346 Mail Flag](/images/tryhackme_dx2_hells_kitchen/web_4346_mail_flag.webp)
...
![Web 4346 Mail Source](/images/tryhackme_dx2_hells_kitchen/web_4346_mail_source.webp)
...
![Web 4346 Websocket](/images/tryhackme_dx2_hells_kitchen/web_4346_websocket.webp)

Trying a simple command injection payload, we see that we are able to execute commands.

![Web 4346 Websocket Command Injection](/images/tryhackme_dx2_hells_kitchen/web_4346_websocket_command_injection.webp)
...
![Jojo Password](/images/tryhackme_dx2_hells_kitchen/jojo_password.webp)
