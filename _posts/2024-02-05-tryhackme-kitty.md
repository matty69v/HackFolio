...
image:
  path: /images/tryhackme_kitty/room_card.webp
---
...
![Tryhackme Room Link](/images/tryhackme_kitty/room_card.webp)
...
- Login (`/index.php`):
![Login page](/images/tryhackme_kitty/webserver_login.webp)

- Register (`/register.php`):
![Register page](/images/tryhackme_kitty/webserver_register.webp)

- After registering an account and logging in (`/welcome.php`):
![Welcome page](/images/tryhackme_kitty/webserver_welcome.webp)
...
![Webserver SQL filter](/images/tryhackme_kitty/webserver_filter.webp)
...
![SQL query resulting in true](/images/tryhackme_kitty/webserver_true_sqli.webp)

- And with the `jxf' and 1=2-- -` payload, login fails and response includes: `Invalid username or password`.

![SQL query resulting in false](/images/tryhackme_kitty/webserver_false_sqli.webp)
...
![Log file clearing](/images/tryhackme_kitty/log_file_clear.webp)
