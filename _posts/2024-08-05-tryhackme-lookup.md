...
image:
  path: /images/tryhackme_lookup/room_card.webp
---
...
![Web 80 Index](/images/tryhackme_lookup/web_80_index.webp)
...
![Web 80 Login One](/images/tryhackme_lookup/web_80_login1.webp)
...
![Web 80 Login Two](/images/tryhackme_lookup/web_80_login2.webp)
...
![Web 80 Login Three](/images/tryhackme_lookup/web_80_login3.webp)
...
![Web 80 Files Index](/images/tryhackme_lookup/web_80_files_index.webp)

Clicking the `About this software` button, we discover that the application version is **2.1.47**.

![Web 80 Files Index Two](/images/tryhackme_lookup/web_80_files_index2.webp)
...
![Elfinder Fix](/images/tryhackme_lookup/elfinder_fix.webp)
...
![Web 80 Files Exploit](/images/tryhackme_lookup/web_80_files_exploit.webp)
...
![Web 80 Files Exploit Two](/images/tryhackme_lookup/web_80_files_exploit2.webp)

![Web 80 Files Exploit Three](/images/tryhackme_lookup/web_80_files_exploit3.webp)
...
![Web 80 Files Exploit Four](/images/tryhackme_lookup/web_80_files_exploit4.webp)

Now, all we have to do is select the `Rotate` option, rotate the image, and click the `Apply` button.

![Web 80 Files Exploit Five](/images/tryhackme_lookup/web_80_files_exploit5.webp)
...
![Web 80 Files Exploit Six](/images/tryhackme_lookup/web_80_files_exploit6.webp)
...
![Pwm Decompilation](/images/tryhackme_lookup/pwm_decompilation.webp)
