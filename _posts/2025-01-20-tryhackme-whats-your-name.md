...
image:
  path: /images/tryhackme_whats_your_name/room_image.webp
---
...
![Web Server Worldwap Index](/images/tryhackme_whats_your_name/worldwap_index.webp)
...
![Web Server Worldwap Register](/images/tryhackme_whats_your_name/worldwap_register.webp)

After registering an account, we get redirected to `http://worldwap.thm/public/html/login.php`, where we can login.

![Web Server Worldwap Login](/images/tryhackme_whats_your_name/worldwap_login.webp)
...
![Web Server Login Worldwap Index](/images/tryhackme_whats_your_name/login_worldwap_index.webp)

Checking the source code for the page, we discover the `login.php` endpoint.

![Web Server Login Worldwap Index Sourcecode](/images/tryhackme_whats_your_name/login_worldwap_index_sourcecode.webp)

At `http://login.worldwap.thm/login.php`, we get a login page.

![Web Server Login Worldwap Login](/images/tryhackme_whats_your_name/login_worldwap_login.webp)
...
![Web Server Worldwap Register XSS Test](/images/tryhackme_whats_your_name/worldwap_register_xsstest.webp)
...
![Web Server Worldwap Register XSS Payload](/images/tryhackme_whats_your_name/worldwap_register_xsspayload.webp)
...
![Web Server Worldwap Dashboard](/images/tryhackme_whats_your_name/worldwap_dashboard.webp)
...
![Web Server Login Worldwap Moderator Flag](/images/tryhackme_whats_your_name/login_worldwap_moderator_flag.webp)
...
![Web Server Login Worldwap Change Password](/images/tryhackme_whats_your_name/login_worldwap_change_password.webp)
...
![Web Server Login Worldwap Change Password Request](/images/tryhackme_whats_your_name/login_worldwap_change_password_request.webp)

At `http://login.worldwap.thm/chat.php`, we are able to send messages to the admin user.

![Web Server Login Worldwap Chat](/images/tryhackme_whats_your_name/login_worldwap_chat.webp)
...
![Web Server Login Worldwap Chat XSS](/images/tryhackme_whats_your_name/login_worldwap_chat_xss.webp)
...
![Web Server Login Worldwap Admin Login](/images/tryhackme_whats_your_name/login_worldwap_admin_login.webp)

After logging in, we get redirected to `http://login.worldwap.thm/profile.php`, where we get the admin flag.

![Web Server Login Worldwap Admin Flag](/images/tryhackme_whats_your_name/login_worldwap_admin_flag.webp)

### CSRF

If we send a link to the admin in the chat, we see the admin user clicking it.

![Web Server Login Worldwap Chat Link](/images/tryhackme_whats_your_name/login_worldwap_chat_link.webp)
...
![Web Server Login Worldwap Chat CSRF Payload](/images/tryhackme_whats_your_name/login_worldwap_chat_csrf.webp)
