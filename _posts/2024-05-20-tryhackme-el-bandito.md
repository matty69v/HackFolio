...
image:
  path: /images/tryhackme_el-bandito/room_card.webp
---
...
![Web Server View Source](/images/tryhackme_el_bandito/web_source_code.webp)
...
![Web Server Login Page](/images/tryhackme_el_bandito/web_login_page.webp)

Trying to send a message using `/send_message`, we also get the same login page.

![Web Server Send Message Login Page](/images/tryhackme_el_bandito/web_sendmessage_login_page.webp)

### Port 8080

Looking at the web server on port 8080, we get a page about Bandit-Coin.

![Web Server Index Page](/images/tryhackme_el_bandito/web_8080_index.webp)

There are two interesting endpoints.

- `/burn.html`

![Web Server Burn Page](/images/tryhackme_el_bandito/web_8080_burn.webp)

The form does not seem to be doing anything.

- `/services.html`

![Web Server Services Page](/images/tryhackme_el_bandito/web_8080_services.webp)
...
![Web Server 404 Page](/images/tryhackme_el_bandito/web_8080_404_page.webp)
...
![Web Server 404 Page](/images/tryhackme_el_bandito/web_8080_actuator_forbidden.webp)

While we are not able to access `/env`, we are able to access `/mappings` actuator.

![Web Server Mappings Actuator](/images/tryhackme_el_bandito/web_8080_mappings_actuator.webp)
...
![Web Server SSRF for Existent Page](/images/tryhackme_el_bandito/web_8080_ssrf_exists.webp)
![Web Server SSRF for Non-Existent Page](/images/tryhackme_el_bandito/web_8080_ssrf_doesnotexist.webp)
...
![Web Server WebSocket Request Smuggling](/images/tryhackme_el_bandito/web_8080_websocket_request_smuggling.webp)
...
![Web Server First Flag](/images/tryhackme_el_bandito/web_8080_first_flag.webp)

And from `/admin-creds`, we get a set of credentials.

![Web Server Admin Credentials](/images/tryhackme_el_bandito/web_8080_admin_creds.webp)
...
![Web Server Chat Page](/images/tryhackme_el_bandito/web_chat_page.webp)
...
![Web Server Request Smuggling Payload](/images/tryhackme_el_bandito/web_request_smuggling_payload.webp)
...
![Web Server Request Smuggling Payload Response](/images/tryhackme_el_bandito/web_request_smuggling_payload_response.webp)
...
![Web Server Request Smuggling Capture Payload](/images/tryhackme_el_bandito/web_request_smuggling_capture.webp)
...
![Web Server Request Smuggling Captured Request](/images/tryhackme_el_bandito/web_request_smuggling_captured_request.webp)
